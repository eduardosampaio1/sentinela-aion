...
#   3. production   — slim non-root runtime
#
# Source protection (enterprise):
#   For bytecode-only images, use tools/build_secure.sh (runs compileall and
#   strips .py sources before the Docker build). Not enabled here to keep the
#   POC build simple and reliable.
#
